...
a = Analysis(['server.py'],
             pathex=['envxVATrainerP38CPU\\lib\\site-packages', 'F:\\Speech\\xVA-Trainer'],
             binaries=[],
             datas=[('envxVATrainerP38CPU\\lib\\site-packages\\torchaudio','envxVATrainerP38CPU\\lib\\site-packages\\torchaudio')],
