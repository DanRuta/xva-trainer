...
try:
    ...
    try:
        ...
        # import python.xvapitch.text.phonecode_tables
    except:
        try:
...
def get_text_preprocessor(code, base_dir, override_useAnyG2P=None):
    ...
    tp_codes = {
        ...
        "en": {
            ...
            "custom_dicts": [f'{base_dir}/dicts/xvadict-elder_scrolls.json'],
    ...
    tp = tp_codes[code]["tp"](base_dir, use_g2p=use_g2p, use_epitran=tp_codes[code]["use_epitran"] if "use_epitran" in tp_codes[code].keys() else None)
