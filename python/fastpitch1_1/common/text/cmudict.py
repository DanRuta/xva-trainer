...
class CMUDict:
  ...
  def __init__(self, file_or_path=None, heteronyms_path=None, keep_ambiguous=True):
    # file_or_path = "F:/Speech/FP1_1_2/cmudict/cmudict-0.7b"
    # file_or_path ="./cmudict/cmudict-0.7b"
    # import os
    # print(os.listdir("./cmudict/cmudict-0.7b"))
    # file_or_path = "F:/Speech/FP1_1_2/cmudict/deuPD.txt"
    # print(f'{file_or_path}')
...
def _parse_cmudict(file):
  ...
  for line in file:
    if len(line) and (line[0] >= 'A' and line[0] <= 'Z' or line[0] == "'"):
      ...
      pronunciation = _get_pronunciation(parts[1] if '  ' in line else " ".join(parts[1:]))
      if pronunciation:
        if word in cmudict:
